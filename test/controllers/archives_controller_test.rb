...
class ArchivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create archive" do
    assert_difference('Archive.count') do
      post archives_url, params: { archive: { description: @archive.description, name: @archive.name, reference: @archive.reference, user_id: @archive.user_id } }
    end
  ...
  test "should update archive" do
    patch archive_url(@archive), params: { archive: { description: @archive.description, name: @archive.name, reference: @archive.reference, user_id: @archive.user_id } }
