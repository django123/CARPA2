class CouriersController < ApplicationController
  ...
  load_and_authorize_resource param_method: :courier_params
  ...
  private
    ...
    def courier_params
      params.require(:courier).permit(:reference, :subject, :sender,
                                      :receiver, :state, :sentDate,
                                      :receiveDate, :order_number, :user_id,
                                      :project_id,:file)
    end
end
